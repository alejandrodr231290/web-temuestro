    ...
    function cargartabla() {
        ...
        $('#tabla').dataTable({
            ...
            columnDefs: [
                {
                    render: function (data, type, row) {
                        if (row.bloqueados > 0) {
                            return '<label class="bloqueados" data-toggle="tooltip" title="Bloqueados" >' + data + '<span class="text-muted" > (' + row.bloqueados + ' B)</span> </label> ';
                        }
                        return data;
                    },
                },
            ...
            initComplete: function () {
                ...
                $('#start').removeAttr('disabled');
                $('#end').removeAttr('disabled');
                var sum = this.api().column(3).data().sum();
